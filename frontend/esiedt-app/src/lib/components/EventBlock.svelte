...
<div
	class="absolute left-14 right-2 overflow-hidden rounded-md border-l-4 border-signal bg-white shadow-sm"
	class:p-2={isTiny}
	class:p-3={!isTiny}
...
>
	<div class="flex h-full flex-col">
		...
		{:else if blockHeight > COMPACT_THRESHOLD}
			<!-- Mode Ligne Compact -->
			<div class="mt-0.5 truncate font-body text-sm text-ink/70">
		...
		{/if}
		<!-- En dessous de 74px : ni assez de place pour une ligne d'infos, on garde juste titre + heure -->
	</div>
</div>